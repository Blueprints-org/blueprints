...
HEA_PROFILES_DATABASE = {
    ...
    "HEA320": __HEAProfileParameters("HEA320", 300, 15.5, 300, 15.5, 320, 9, 27, 27),
    "HEA340": __HEAProfileParameters("HEA340", 300, 16.5, 300, 16.5, 340, 9.5, 27, 27),
    "HEA360": __HEAProfileParameters("HEA360", 300, 17.5, 300, 17.5, 360, 10, 27, 27),
    "HEA400": __HEAProfileParameters("HEA400", 300, 19, 300, 19, 400, 11, 27, 27),
    "HEA450": __HEAProfileParameters("HEA450", 300, 21, 300, 21, 450, 11.5, 27, 27),
    "HEA500": __HEAProfileParameters("HEA500", 300, 23, 300, 23, 500, 12, 27, 27),
    "HEA550": __HEAProfileParameters("HEA550", 300, 24, 300, 24, 550, 12.5, 27, 27),
    "HEA600": __HEAProfileParameters("HEA600", 300, 25, 300, 25, 600, 13, 27, 27),
    "HEA650": __HEAProfileParameters("HEA650", 300, 26, 300, 26, 650, 13.5, 27, 27),
    "HEA700": __HEAProfileParameters("HEA700", 300, 27, 300, 27, 700, 14.5, 27, 27),
    "HEA800": __HEAProfileParameters("HEA800", 300, 28, 300, 28, 800, 15, 30, 30),
    "HEA900": __HEAProfileParameters("HEA900", 300, 30, 300, 30, 900, 16, 30, 30),
    "HEA1000": __HEAProfileParameters("HEA1000", 300, 31, 300, 31, 1000, 16.5, 30, 30),
}

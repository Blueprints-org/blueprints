...
class StressStrainResult:
    ...
    regime : Regime
        The regime that actually produced the result (``SLS_UNCRACKED`` or ``SLS_CRACKED``, never
        ``AUTO``). Single source of truth for the regime; :attr:`is_cracked` derives from it.

"""Formula 5.17 from NEN-EN 1993-5:2008: Chapter 5 - Ultimate limit state."""
...
class Form5Dot17CompressionCheckZProfilesClass1And2(Formula):
    ...
    def __init__(
        ...
        NEN-EN 1993-5:2008 art. 5.2.3 (10) - Formula (5.17)

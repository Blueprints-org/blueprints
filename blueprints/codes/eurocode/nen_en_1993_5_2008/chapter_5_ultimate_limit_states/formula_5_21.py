"""Formula 5.21 from NEN-EN 1993-5:2008: Chapter 5 - Ultimate Limit States."""
...
class Form5Dot21ReducedMomentResistanceClass2UProfiles(Formula):
    r"""Class representing formula 5.21 for the calculation of [$M_N,Rd$] for Class 2 U-profiles."""
    ...
    def __init__(
        ...
        NEN-EN 1993-5:2008 art. 5.2.3 (11) - Formula (5.21)

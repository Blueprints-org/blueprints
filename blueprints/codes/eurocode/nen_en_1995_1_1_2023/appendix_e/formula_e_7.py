"""Formula E.7 from NEN-EN 1995-1-1:2023."""
...
class FormEDot7SecondMomentInertia(Formula):
    ...
    def __init__(self, b_i: MM, h_i: MM, i: int) -> None:
        ...
        NEN-EN 1995-1-1 art E.4(1) - Formula (E.7)
    ...
    def latex(self) -> LatexFormula:
        ...
        return LatexFormula(
            return_symbol=f"I_{self.i}", result=f"{self:.2f}", equation=eq_i, numeric_equation=numeric_eq, comparison_operator_label="="
        )

...
from blueprints.codes.eurocode.national_annex.nl.nen_en_1992_1_1_a1_2020.chapter_4_durability_and_cover.table_4_1 import Table4Dot1ExposureClasses
...
class Table4Dot4nMinimumCoverDurabilityReinforcementSteel(Formula):
    ...
    def __init__(
        ...
        NEN-EN 1992-1-1:2005+A1:2015+NB:2016+A1:2020 art.4.4.1.2 (5) - Table (4.4N)

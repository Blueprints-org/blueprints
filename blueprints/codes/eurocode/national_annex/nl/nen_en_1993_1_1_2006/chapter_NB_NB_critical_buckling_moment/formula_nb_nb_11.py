...
class FormNBDotNB11CoefficientC(Formula):
    ...
    def latex(self, n: int = 3) -> LatexFormula:
        ...
        _equation: str = r"\frac{\pi \cdot C_1 \cdot L_g}{L_{kip}} \cdot \left( \sqrt{1 + \frac{\pi^2 \cdot S^2}{L_{kip}^2} \cdot \left(C_2^2 + 1\right)} + \frac{\pi \cdot C_2 \cdot S}{L_{kip}} \right)"

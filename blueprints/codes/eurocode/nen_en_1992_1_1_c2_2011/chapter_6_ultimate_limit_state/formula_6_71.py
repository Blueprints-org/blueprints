...
class Form6Dot71CriteriaBasedOnStressRangeLHS(Formula):
    ...
    def __init__(
        ...
        """[$Δσ_{Ed}$] Loading side of equation [$MPa$].
        ...
        ----------
        gamma_f_fat : DIMENSIONLESS
            [$γ_{F,fat}$] Partial factor for fatigue actions [$-$].
        delta_sigma_s_equ_n_star : MPA
            [$Δσ_{s,equ}(N*)$] Damage equivalent stress range for types of reinforcement and considering number of cycles N* [$MPa$].
...
class Form6Dot71CriteriaBasedOnStressRangeRHS(Formula):
    ...
    def __init__(
        ...
        """[$Δσ_{Rd}$] Resistance side of equation [$MPa$].
        ...
        ----------
        delta_sigma_rsk_n_star : MPA
            [$Δσ_{Rsk}(N*)$] Stress range at N* cycles from the S-N curve in Figure 6.30 [$MPa$].
        gamma_s_fat : DIMENSIONLESS

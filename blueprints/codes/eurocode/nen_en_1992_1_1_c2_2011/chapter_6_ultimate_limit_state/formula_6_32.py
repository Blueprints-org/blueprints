...
class Form6Dot32EffectiveDepthSlab(Formula):
    r"""Class representing formula 6.32 for the calculation of the effective depth of the slab, :math:`d_{eff}`."""
    ...
    def __init__(
        ...
        r"""[:math:`d_{eff}`] Effective depth of the slab [:math:`mm`].
        ...
        ----------
        d_y : MM
            [:math:`d_{y}`] Effective depth of the reinforcement in the y-direction [:math:`mm`].
        d_z : MM
            [:math:`d_{z}`] Effective depth of the reinforcement in the z-direction [:math:`mm`].
        """
        super().__init__()
        self.d_y = d_y
        self.d_z = d_z

...
class Form6Dot62DesignValueCompressiveStressResistance(Formula):
    r"""Class representing formula 6.62 for the calculation of :math:`\sigma_{Rd,max}`."""
    ...
    def __init__(
        ...
        ----------
        k_3 : float
            :math:`k_3` Coefficient for the design value of compressive stress resistance [-].
            Note: The value of :math:`k_3` for use in a Country may be found in its National Annex.

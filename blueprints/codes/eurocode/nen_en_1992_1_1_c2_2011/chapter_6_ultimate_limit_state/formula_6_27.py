...
from blueprints.type_alias import N_M, M, N
from blueprints.validations import raise_if_negative


class Form6Dot27ShearForceInWall(Formula):
    r"""Class representing formula 6.27 for the calculation of the shear force in a wall, :math:`V_{Ed,i}`."""
    ...
    def __init__(
        ...
        r"""[:math:`V_{Ed,i}`] Shear force in a wall [:math:`kN`].
        ...
        ----------
        tau_t_i_t_ef_i : N_M
            [:math:`\tau_{t,i} t_{ef,i}`] Shear stress times effective thickness [:math:`N/m`].
        z_i : M
            [:math:`z_{i}`] is the side length of wall i defined by the distance between the intersection points with the adjacent walls [:math:`m`].
        """
        super().__init__()

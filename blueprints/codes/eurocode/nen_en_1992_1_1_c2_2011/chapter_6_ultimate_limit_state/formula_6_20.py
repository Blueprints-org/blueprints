...
class Form6Dot20LongitudinalShearStress(Formula):
    r"""Class representing formula 6.20 for the calculation of the longitudinal shear stress, :math:`v_{Ed}`."""
    ...
    def __init__(
        ...
        r"""[:math:`v_{Ed}`] Longitudinal shear stress [:math:`MPa`].
        ...
        ----------
        delta_f_d : N
            [:math:`\Delta F_{d}`] Change of the normal force in the flange over the length :math:`\Delta x` [:math:`N`].
        h_f : MM
            [:math:`h_{f}`] Thickness of flange at the junctions [:math:`mm`].
        delta_x : MM
            [:math:`\Delta x`] Length under consideration, see Figure 6.7 [:math:`mm`].
        """
        super().__init__()

...
class Form3Dot15DesignValueCompressiveStrength(Formula):
    """Class representing formula 3.15 for the calculation of the compressive strength design value [MPa]."""
    ...
    def __init__(
        ...
        """[fcd] Design value compressive strength [MPa].

        NEN-EN 1992-1-1+C2:2011 art.3.1.3(1) - Formula (3.15)

...
class Form8Dot15PrestressTransferStress(Formula):
    ...
    def __init__(
        ...
        """[:math:`f_{bpt}`] Constant bond stress at which prestress is assumed to be transfered to the concrete [MPa].
        ...
        eta_p1 : DIMENSIONLESS
            ...
            Use your own implementation for this value or use SubForm8Dot15EtaP1 class.
        eta_1 : DIMENSIONLESS
        ...
        f_ctd_t : MPA
            [:math:`f_{ctd}(t)`] Design tensile value of strength at time of release [mm].
            = :math:`α_{ct} * 0.7 * f_{ctm}(t) / γ_c` (see 3.1.2(9) and 3.1.6(2)P)
            Use your own implementation for this value or use SubForm8Dot15TensileStrengthAtRelease class.
        """
        super().__init__()
        self.eta_p1 = eta_p1
        self.eta_1 = eta_1
...
class SubForm8Dot15TensileStrengthAtRelease(Formula):
    ...
    def __init__(
        ...
        """[:math:`f_{ctd}(t)`] Design tensile value of strength at time of release [MPa].
        ...
        f_ctm_t : MPA
            [:math:`f_{ctm}(t)`] Mean value of tensile strength at time of release (see formula 3.4) [MPa].
            Use your own implementation for this value or use Form3Dot4DevelopmentTensileStrength class.
        gamma_c : DIMENSIONLESS
            [:math:`γ_c`] Partial safety factor for concrete [-].
        """
        super().__init__()

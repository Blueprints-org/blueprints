...
class Form8Dot3RequiredAnchorageLength(Formula):
    ...
    def __init__(
        ...
        r"""[$l_{b,rqd}$] Basic required anchorage length, for anchoring the force ${s} \\cdot σ_{sd}$ in a straight bar assuming
        constant bond stress $_{bd}$. [mm].
        ...
        sigma_sd: MPA
            [$σ_{sd}$] design stress of the bar at the position from where the anchorage is measured from [MPa].
        f_bd: MPA

...
class Form8Dot11MinimumDesignLapLength(Formula):
    ...
    def __init__(
        ...
        """[:math:`l0,min`] Design minimum lap length [mm].
        ...
        alpha_6 : DIMENSIONLESS
            ...
            = :math:`(\frac{ρ_l}{25})^{0.5} ≤ 1.5` with a minimum of :math:`1.0`.
        ...
        l_b_rqd: MM
            [:math:`l{b,rqd}`] Basic required anchorage length, for anchoring the force :math:`A_s σ_{sd}` in a straight bar assuming constant

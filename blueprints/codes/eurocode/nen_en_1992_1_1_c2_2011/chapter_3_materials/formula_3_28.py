...
class Form3Dot28RatioLossOfPreStressClass1(Formula):
    ...
    def __init__(
        ...
        """[Δσpr / σpi] Ratio between loss of pre-stress and initial pre-stress for class 2 [-].
    ...
    def latex(self) -> LatexFormula:
        ...
        return LatexFormula(
            ...
            numeric_equation=(
                rf"5.39 \cdot {self.rho_1000:.3f} \cdot e^{{6.7 \cdot {self.mu:.3f}}} \left( \frac{{{self.t:.3f}}}{{1000}} \right)"

...
class Form6Dot42LongitudinalStressClass3CrossSections(ComparisonFormula):
    r"""Class representing formula 6.42 for Class 3 cross-sections: [$\sigma_{x,Ed} \leq \frac{f_y}{\gamma_{M0}}$]."""

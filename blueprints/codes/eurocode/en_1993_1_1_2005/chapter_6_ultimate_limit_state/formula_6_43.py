"""Formula 6.43 from EN 1993-1-1:2005: Chapter 6 - Ultimate limit state."""
...
class Form6Dot43LongitudinalStressClass4CrossSections(ComparisonFormula):
    r"""Class representing formula 6.43 for Class 4 cross-sections: [$\sigma_{x,Ed} \leq \frac{f_y}{\gamma_{M0}}$]."""

...
from blueprints.validations import raise_if_less_or_equal_to_zero, raise_if_mismatch_sign
...
class Form5Dot2ElasticCriticalBucklingFactor(Formula):
    ...
    def _evaluate(
        ...
        if v_ed == 0.0:
            raise ValueError(f"Invalid value for 'v_ed': {v_ed}. Value cannot be zero.")

...
according to Table 4.3 from EN 1992-1-1:2004: Chapter 4 - Durability and cover to reinforcement.
"""
...
"""Design working life in years as defined in table 4.3 of EN 1992-1-1:2004."""
...
class ConcreteStructuralClassCalculator(AbstractConcreteStructuralClassCalculator):
    ...
    In accordance with:
    EN 1992-1-1:2004 Concrete - General
    """
    ...
    def _structural_class_delta_design_working_life(self) -> None:
        ...
        In accordance with:
        NEN 1992-1-1:2004 Concrete - General
        """

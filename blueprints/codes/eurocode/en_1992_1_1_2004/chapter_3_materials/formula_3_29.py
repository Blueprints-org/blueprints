"""Formula 3.29 from EN 1992-1-1:2004: Chapter 3 - Materials."""
...
class Form3Dot29RatioLossOfPreStressClass2(Formula):
    ...
    def __init__(
        ...
        EN 1992-1-1:2004 art.3.3.2(7) - Formula (3.29)
    ...
    def latex(self, n: int = 3) -> LatexFormula:
        ...
        return LatexFormula(
            ...
            numeric_equation=(
                rf"0.66 \cdot {self.rho_1000:.{n}f} \cdot e^{{9.1 \cdot {self.mu:.{n}f}}} \left( \frac{{{self.t:.{n}f}}}{{1000}} \right)"

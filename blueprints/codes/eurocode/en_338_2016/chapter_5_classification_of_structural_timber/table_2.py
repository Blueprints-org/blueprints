...
class TimberStrengthClassTension(Enum):
...
class Table2StrengthClassesSoftwoodTensionTests:
    ...
    Parameters
    ----------
    timber_class : TimberStrengthClassTension
    ...
    Examples
    --------
    >>> table = Table2StrengthClassesSoftwoodTensionTests(TimberStrengthClassTension.T14)
    >>> table.f_t_0_k
    14
    >>> table.e_t_0_mean
    11.0
    ...
    # Format: {TimberStrengthClassTension: (f_m_k, f_t_0_k, f_t_90_k, f_c_0_k, f_c_90_k, f_v_k,
    #                                        E_t_0_mean, E_t_0_k, E_t_90_mean, G_mean, rho_k, rho_mean)}
    _strength_data: ClassVar[dict[TimberStrengthClassTension, tuple[float, ...]]] = {
        TimberStrengthClassTension.T8: (13.5, 8, 0.4, 16, 2.0, 2.8, 7.0, 4.7, 0.23, 0.44, 290, 350),
        TimberStrengthClassTension.T9: (14.5, 9, 0.4, 17, 2.1, 3.0, 7.5, 5.0, 0.25, 0.47, 300, 360),
        TimberStrengthClassTension.T10: (16, 10, 0.4, 17, 2.2, 3.2, 8.0, 5.4, 0.27, 0.50, 310, 370),
        TimberStrengthClassTension.T11: (17, 11, 0.4, 18, 2.2, 3.4, 9.0, 6.0, 0.30, 0.56, 320, 380),
        TimberStrengthClassTension.T12: (18, 12, 0.4, 19, 2.3, 3.6, 9.5, 6.4, 0.32, 0.59, 330, 400),
        TimberStrengthClassTension.T13: (19.5, 13, 0.4, 20, 2.4, 3.8, 10.0, 6.7, 0.33, 0.63, 340, 410),
        TimberStrengthClassTension.T14: (20.5, 14, 0.4, 21, 2.5, 4.0, 11.0, 7.4, 0.37, 0.69, 350, 420),
        TimberStrengthClassTension.T14_5: (21, 14.5, 0.4, 21, 2.5, 4.0, 11.0, 7.4, 0.37, 0.69, 350, 420),
        TimberStrengthClassTension.T15: (22, 15, 0.4, 21, 2.5, 4.0, 11.5, 7.7, 0.38, 0.72, 360, 430),
        TimberStrengthClassTension.T16: (23, 16, 0.4, 22, 2.6, 4.0, 11.5, 7.7, 0.38, 0.72, 370, 440),
        TimberStrengthClassTension.T18: (25.5, 18, 0.4, 23, 2.7, 4.0, 12.0, 8.0, 0.40, 0.75, 380, 460),
        TimberStrengthClassTension.T21: (29, 21, 0.4, 25, 2.7, 4.0, 13.0, 8.7, 0.43, 0.81, 390, 470),
        TimberStrengthClassTension.T22: (30.5, 22, 0.4, 26, 2.7, 4.0, 13.0, 8.7, 0.43, 0.81, 390, 470),
        TimberStrengthClassTension.T24: (33, 24, 0.4, 27, 2.8, 4.0, 13.5, 9.0, 0.45, 0.84, 400, 480),
        TimberStrengthClassTension.T26: (35, 26, 0.4, 28, 2.9, 4.0, 14.0, 9.4, 0.47, 0.88, 410, 490),
        TimberStrengthClassTension.T27: (36.5, 27, 0.4, 29, 2.9, 4.0, 15.0, 10.1, 0.50, 0.94, 410, 490),
        TimberStrengthClassTension.T28: (37.5, 28, 0.4, 29, 2.9, 4.0, 15.0, 10.1, 0.50, 0.94, 420, 500),
        TimberStrengthClassTension.T30: (40, 30, 0.4, 30, 3.0, 4.0, 15.5, 10.4, 0.52, 0.97, 430, 520),
    }
    ...
    def __post_init__(self) -> None:
        ...
        if self.timber_class not in self._strength_data:
            valid_classes = ", ".join([cls.name for cls in TimberStrengthClassTension])

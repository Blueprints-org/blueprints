r"""Corner point of a standard EN 1993-1-9:2005 fatigue strength curve.
...
[$N_D$] and the cut-off limit ``L`` at [$N_L$]. The :func:`form7_curve_corner_points` helper returns these points

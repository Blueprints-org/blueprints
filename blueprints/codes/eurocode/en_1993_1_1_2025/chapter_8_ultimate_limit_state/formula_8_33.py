"""Formula 8.33 from EN 1993-1-1:2025: Chapter 8 - Ultimate Limit State."""
...
class Form8Dot33VplTRdHollowSection(Formula):
    r"""Class representing formula 8.33 for the calculation of [$V_{pl,T,Rd}$]."""
    ...
    def __init__(
        ...
        EN 1993-1-1:2025 art.8.2.7(9) - Formula (8.33)

...
def add_material_steel_info(report: Report, steel_cross_section: SteelCrossSection, n: int = 2) -> None:
    ...
    report.add_table(
        ...
        rows=[
            ["Material", steel_cross_section.material.name],
            ["Yield Strength $f_y$", f"{steel_cross_section.yield_strength or 0.0:.{n}f} MPa"],
            ["Ultimate Strength $f_u$", f"{steel_cross_section.ultimate_strength or 0.0:.{n}f} MPa"],
            ["Elastic Modulus $E$", f"{steel_cross_section.material.e_modulus or 0.0:.{n}f} MPa"],
        ],
    )

...
class ReportToWordConverter:
    ...
    use the Report class to create the LaTeX content, converted with a .to_document() method, for best compatibility.
    ...
    >>> report = LatexReport("My Report Title")
    >>> report.add_section("Introduction")
    >>> report.add_text("This is some text.")
    ...
    >>> report.add_text("Bold and", bold=True).add_text(" normal text.").add_newline(n=6)

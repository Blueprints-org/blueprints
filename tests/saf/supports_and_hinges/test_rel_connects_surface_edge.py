...
class TestRelConnectsSurfaceEdgeValidInitialization:
    ...
    def test_hinged_edge_basic(self):
    ...
    def test_with_different_edge_indices(self):
    ...
    def test_with_relative_coordinates(self):
    ...
    def test_with_from_end_origin(self):
    ...
    def test_with_zero_length_hinge(self):
        ...
        for ux in constraint_types:
            for uy in constraint_types:
                for uz in constraint_types:
                    ...
                    hinge = RelConnectsSurfaceEdge(**kwargs)
                    assert hinge.ux == ux
                    assert hinge.uy == uy
                    assert hinge.uz == uz
                    count += 1

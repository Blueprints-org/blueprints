...
class TestNominalConcreteCover:
    ...
    def test_latex_representation(self) -> None:
        ...
        assert (
            ...
            r"max{Nominal concrete cover according to art. 4.4.1 } (c_{nom}) \text{, Minimum cover with regard to casting surface "
            r"according to art. 4.4.1.3 (4) } \newline"
            r"= \max \left\{55.0; 110.0\right\} = 110.0 mm\newline \newline "
            r"\text{Where:}\newline "
            r"\text{}c_{nom} = c_{min,total}+\Delta c_{dev} = 45.0+10 = 55.0 mm\newline "
            ...
            r"\Delta c_{uneven surface} \text{ and } \Delta c_{abrasion class} \text{ are determined according to art. 4.4.1.2 (11) "
            r"and (13)}\newline "
            ...
            r"\Delta c_{dur,\gamma} , \Delta c_{dur,st} \text{ and } \Delta c_{dur,add} \text{ are determined according to art. "
            r"4.4.1.2 (6), (7) and (8)}\newline "
            r"c_{min,b} \text{ is determined according to table 4.2 based on (equivalent) rebar diameter + 5} = 25 + 5 = 30 mm\newline "
            r"c_{min,dur} \text{ is determined according to table 4.4 based on structural class S4 & exposure classes (XC1, XD1, XS1)} "
            r"= 35 mm\newline "
            r"\text{Minimum cover with regard to casting surface according to art. 4.4.1.3 (4) = }k2 \ge c_{min,dur} + 75 mm for "
            r"Directly against soil\newline "
        )

...
class TestStirrup:
    ...
    def test_mandrel_diameter_factor(self, stirrup: Stirrup) -> None:
    ...
    def test_weight_per_meter(self, stirrup: Stirrup) -> None:
    ...
    def test_ctc_distance_legs(self, stirrup: Stirrup) -> None:
    ...
    def test_cover_used(self, stirrup: Stirrup) -> None:
        """Test the cover used."""
    ...
    def test_relative_start_position(self, stirrup: Stirrup) -> None:
        """Test the relative start position."""
        assert stirrup.relative_start_position == 0.0

    def test_relative_end_position(self, stirrup: Stirrup) -> None:

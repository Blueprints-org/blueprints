...
class TestAnnularSectorProfile:
    ...
    def test_max_thickness(self, annular_sector_profile: AnnularSectorProfile) -> None:
        """Test the max_element_thickness property of the AnnularSectorProfile class."""
        expected_max_thickness = 20.0
        assert annular_sector_profile.max_element_thickness == pytest.approx(expected=expected_max_thickness, rel=1e-6)

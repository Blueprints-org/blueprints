...
class TestCircularProfile:
    ...
    def test_max_thickness(self, circular_profile: CircularProfile) -> None:
        """Test the max_element_thickness property of the CircularProfile class."""
        expected_max_thickness = 200.0
        assert circular_profile.max_element_thickness == pytest.approx(expected=expected_max_thickness, rel=1e-6)

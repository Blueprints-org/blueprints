...
class TestHexagonalProfile:
    ...
    def test_max_thickness(self, hexagonal_profile: HexagonalProfile) -> None:
        """Test the max_element_thickness property of the HexagonalProfile class."""
        expected_max_thickness = hexagonal_profile.side_length * np.sqrt(3)
        assert hexagonal_profile.max_element_thickness == pytest.approx(expected=expected_max_thickness, rel=1e-6)

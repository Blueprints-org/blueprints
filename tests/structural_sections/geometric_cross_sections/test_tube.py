...
class TestTubeCrossSection:
    ...
    def test_area(self, tube_cross_section: TubeProfile) -> None:
    ...
    def test_wall_thickness(self, tube_cross_section: TubeProfile) -> None:
    ...
    def test_polygon(self, tube_cross_section: TubeProfile) -> None:
    ...
    def test_section(self, tube_cross_section: TubeProfile) -> None:
        """Test the section object of the TubeCrossSection class."""
        section = tube_cross_section._section()  # noqa: SLF001
        assert section is not None

    def test_geometry(self, tube_cross_section: TubeProfile) -> None:
        """Test the geometry property of the TubeCrossSection class."""
        geometry = tube_cross_section._geometry()  # noqa: SLF001
        assert geometry is not None

    def test_mesh_settings(self, tube_cross_section: TubeProfile) -> None:
    ...
    def test_no_plotter_defined(self, tube_cross_section: TubeProfile) -> None:
    ...
    def test_immutability(self, tube_cross_section: TubeProfile) -> None:
        """Test that the TubeCrossSection dataclass is immutable."""
        with pytest.raises(AttributeError):
            tube_cross_section.name = "New Name"  # type: ignore[misc]

    def test_transform(self, tube_cross_section: TubeProfile) -> None:
        ...
        assert isinstance(transformed_section, TubeProfile)
        ...
        assert pytest.approx(transformed_section.profile_height, rel=1e-6) == tube_cross_section.profile_width

"""Test for the PAU standard profiles."""
...
from blueprints.structural_sections.steel.standard_profiles.pau import PAU, PAU_PROFILES_DATABASE
from blueprints.structural_sections.steel.standard_profiles.pau import __PAUProfileParameters as PAUProfileParameters


class TestPAU:
    """Tests for the PAU class."""
    ...
    @pytest.mark.parametrize(("profile_name", "expected_data"), PAU_PROFILES_DATABASE.items())
    def test_as_pau_profile(self, profile_name: str, expected_data: PAUProfileParameters) -> None:
        """Test that the PAU instance is converted to an PAUProfile correctly."""
        profile = getattr(PAU, profile_name)
    ...
    @pytest.mark.parametrize("profile_name", PAU_PROFILES_DATABASE.keys())

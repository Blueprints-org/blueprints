"""Test for the PU standard profiles."""
...
from blueprints.structural_sections.steel.standard_profiles.pu import PU, PU_PROFILES_DATABASE
from blueprints.structural_sections.steel.standard_profiles.pu import __PUProfileParameters as PUProfileParameters


class TestPU:
    """Tests for the PU class."""
    ...
    @pytest.mark.parametrize(("profile_name", "expected_data"), PU_PROFILES_DATABASE.items())
    def test_as_pu_profile(self, profile_name: str, expected_data: PUProfileParameters) -> None:
        """Test that the PU instance is converted to an PUProfile correctly."""
        profile = getattr(PU, profile_name)
    ...
    @pytest.mark.parametrize("profile_name", PU_PROFILES_DATABASE.keys())
    ...
    def test_equality_and_identity(self) -> None:
        """Test the equality and identity of PU profiles."""
        profile1 = PU.PU12
        profile2 = PU.PU12

"""Test for the AU standard profiles."""
...
from blueprints.structural_sections.steel.standard_profiles.au import AU, AU_PROFILES_DATABASE
from blueprints.structural_sections.steel.standard_profiles.au import __AUProfileParameters as AUProfileParameters


class TestAU:
    """Tests for the AU class."""
    ...
    @pytest.mark.parametrize(("profile_name", "expected_data"), AU_PROFILES_DATABASE.items())
    def test_as_au_profile(self, profile_name: str, expected_data: AUProfileParameters) -> None:
        """Test that the AU instance is converted to an AUProfile correctly."""
        profile = getattr(AU, profile_name)
    ...
    @pytest.mark.parametrize("profile_name", AU_PROFILES_DATABASE.keys())
    ...
    def test_equality_and_identity(self) -> None:
        """Test the equality and identity of AU profiles."""
        profile1 = AU.AU14
        profile2 = AU.AU14

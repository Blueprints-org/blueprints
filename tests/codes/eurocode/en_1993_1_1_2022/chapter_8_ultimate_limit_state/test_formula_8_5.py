"""Testing formula 8.5 from EN 1993-1-1:2022, chapter 8, ultimate limit state."""
...
class TestForm8Dot5MinDeductionAreaStaggeredFastenerHoles:
    """Validation for formula 8.5 from EN 1993-1-1:2022, chapter 8, ultimate limit state."""

"""Testing formula 8.32 from EN 1993-1-1:2022, chapter 8, ultimate limit state."""

import pytest

from blueprints.codes.eurocode.en_1993_1_1_2022.chapter_8_ultimate_limit_state.formula_8_32 import Form8Dot32VplTRdChannelSection
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm8Dot32VplTRdChannelSection:
    """Validation for formula 8.32 from EN 1993-1-1:2022, chapter 8, ultimate limit state."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                r"V_{pl,T,Rd} = \left( \sqrt{1 - \frac{\tau_{t,Ed}}{1.25 \cdot \left( f_y / \sqrt{3} \right) / \gamma_{M0}}} - "
                r"\frac{\tau_{w,Ed}}{\left( f_y / \sqrt{3} \right) / \gamma_{M0}} \right) \cdot V_{pl,Rd} = "
                r"\left( \sqrt{1 - \frac{100.000 \ MPa}{1.25 \cdot \left( 355.000 \ MPa / \sqrt{3} \right) / 1.000}} - "
                r"\frac{50.000 \ MPa}{\left( 355.000 \ MPa / \sqrt{3} \right) / 1.000} \right) \cdot 200000.000 \ N = 107373.685 \ N",
            ),
        ],
    )

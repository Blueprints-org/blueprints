"""Testing formula 8.45 from EN 1993-1-1:2022, chapter 8, ultimate limit state."""
...
class TestForm8Dot45CheckAxialForceY:
    """Validation for formula 8.45 from EN 1993-1-1:2022, chapter 8, ultimate limit state."""

...
from blueprints.codes.eurocode.nen_en_1992_1_1_c2_2011.chapter_3_materials.formula_3_23 import Form3Dot23TensileBendingStrength
...
class TestForm3Dot23TensileBendingStrength:
    ...
    def test_evaluation_1(self) -> None:
        ...
        form_3_23 = Form3Dot23TensileBendingStrength(h=h, f_ctm=f_ctm)
    ...
    def test_raise_error_when_negative_h_is_given(self) -> None:
        ...
        with pytest.raises(ValueError):
            Form3Dot23TensileBendingStrength(h=h, f_ctm=f_ctm)

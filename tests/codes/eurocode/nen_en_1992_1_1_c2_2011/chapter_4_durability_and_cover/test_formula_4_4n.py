"""Testing formula 4.3N of NEN-EN 1992-1-1+C2:2011."""

import pytest

from blueprints.codes.eurocode.nen_en_1992_1_1_c2_2011.chapter_4_durability_and_cover.formula_4_4n import Form4Dot4NCheckExecutionTolerances
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm4Dot4NCheckExecutionTolerances:
    """Validation for formula 4.3N from NEN-EN 1992-1-1+C2:2011."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "complete",
                r"CHECK \to 0 \leq \Delta c_{dev} \leq 10 \to 0 \leq 7.000 \leq 10 \to OK",
            ),
            ("short", r"CHECK \to OK"),
        ],
    )

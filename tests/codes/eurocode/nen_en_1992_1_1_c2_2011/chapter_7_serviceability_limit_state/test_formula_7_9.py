"""Testing formula 7.9 of NEN-EN 1992-1-1+C2:2011."""

import pytest

from blueprints.codes.eurocode.nen_en_1992_1_1_c2_2011.chapter_7_serviceability_limit_state.formula_7_9 import Form7Dot9EpsilonSmMinusEpsilonCm
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm7Dot9EpsilonSmMinusEpsilonCm:
    """Validation for formula 7.9 from NEN-EN 1992-1-1+C2:2011."""
    ...
    @pytest.mark.parametrize(
        ("sigma_s", "k_t", "f_ct_eff", "rho_p_eff", "e_s", "e_c"),
        [
            ...
            (400.0, 0.6, 2.5, 0.02, 200000.0, -30000.0),  # e_c is negative
        ],
    )
    def test_raise_error_when_invalid_values_are_given(
        self, sigma_s: float, k_t: float, f_ct_eff: float, rho_p_eff: float, e_s: float, e_c: float
    ) -> None:
        """Test invalid values."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                r"\cdot \left(1 + \frac{E_s}{E_c} \cdot \rho_{p,eff}\right)}{E_s}; \frac{0.6 \cdot \sigma_s}{E_s}\right)"

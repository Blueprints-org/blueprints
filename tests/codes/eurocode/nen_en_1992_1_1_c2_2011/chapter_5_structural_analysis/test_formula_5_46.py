"""Testing formula 5.46 of NEN-EN 1992-1-1+C2:2011."""

import pytest

from blueprints.codes.eurocode.nen_en_1992_1_1_c2_2011.chapter_5_structural_analysis.formula_5_46 import Form5Dot46TimeDependentLosses
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm5Dot46TimeDependentLosses:
    """Validation for formula 5.46 from NEN-EN 1992-1-1+C2:2011."""
    ...
    def test_evaluation(self) -> None:
        ...
        # Object to test
        formula = Form5Dot46TimeDependentLosses(
            a_p=a_p,
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Object to test
        latex = Form5Dot46TimeDependentLosses(
            a_p=a_p,
            epsilon_cs=epsilon_cs,
            e_p=e_p,
            delta_sigma_pr=delta_sigma_pr,

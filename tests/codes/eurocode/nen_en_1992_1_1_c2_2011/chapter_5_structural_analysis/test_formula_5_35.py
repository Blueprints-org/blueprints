"""Testing formula 5.35 of NEN-EN 1992-1-1+C2:2011."""

import pytest

from blueprints.codes.eurocode.nen_en_1992_1_1_c2_2011.chapter_5_structural_analysis.formula_5_35 import Form5Dot35EffectiveDepth
from blueprints.validations import LessOrEqualToZeroError


class TestForm5Dot35EffectiveDepth:
    """Validation for formula 5.35 from NEN-EN 1992-1-1+C2:2011."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "complete",
                r"d = \frac{h}{2} + i_s = \frac{300.000}{2} + 50.000 = 200.000 \text{ mm}",
            ),
            ("short", r"d = 200.000 \text{ mm}"),
        ],
    )

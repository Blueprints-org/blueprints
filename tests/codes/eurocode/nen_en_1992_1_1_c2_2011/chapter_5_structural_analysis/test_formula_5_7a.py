"""Testing formula 5.7a of NEN-EN 1992-1-1+C2:2011."""
...
class TestForm5Dot7aFlangeEffectiveFlangeWidth:
    """Validation for formula 5.7a from NEN-EN 1992-1-1+C2:2011."""
    ...
    def test_evaluation(self, b_i: float, l_0: float, b_eff_i: float) -> None:
        ...
        # Object to test
        form_5_7_a = Form5Dot7aFlangeEffectiveFlangeWidth(b_i=b_i, l_0=l_0)

        # Expected result, manually calculated
        manually_calculated_result = b_eff_i  # M

        assert form_5_7_a == pytest.approx(expected=manually_calculated_result, rel=1e-4)
    ...
    def test_raise_error_when_negative_values_are_given(
        ...
        with pytest.raises(NegativeValueError):
            Form5Dot7aFlangeEffectiveFlangeWidth(b_i=b_i, l_0=l_0)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Object to test
        form_5_7_a_latex = Form5Dot7aFlangeEffectiveFlangeWidth(b_i=b_i, l_0=l_0).latex()

        actual = {
            "complete": form_5_7_a_latex.complete,
            "short": form_5_7_a_latex.short,
        }

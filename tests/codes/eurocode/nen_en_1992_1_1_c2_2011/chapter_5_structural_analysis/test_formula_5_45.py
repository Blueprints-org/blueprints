"""Testing formula 5.45 of NEN-EN 1992-1-1+C2:2011."""

import pytest

from blueprints.codes.eurocode.nen_en_1992_1_1_c2_2011.chapter_5_structural_analysis.formula_5_45 import Form5Dot45LossesDueToFriction
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm5Dot45LossesDueToFriction:
    """Validation for formula 5.45 from NEN-EN 1992-1-1+C2:2011."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                r"1000.000 \cdot \left( 1 - e^{-0.200 \cdot (0.100 + 0.010 \cdot 50.000)} \right) = 113.080 \text{ kN}",
            ),
            ("short", r"\Delta P_{\mu}(x) = 113.080 \text{ kN}"),
        ],
    )

"""Testing formula 5.33 of NEN-EN 1992-1-1+C2:2011."""

import pytest

from blueprints.codes.eurocode.nen_en_1992_1_1_c2_2011.chapter_5_structural_analysis.formula_5_33 import Form5Dot33NominalSecondOrderMoment
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm5Dot33NominalSecondOrderMoment:
    """Validation for formula 5.33 from NEN-EN 1992-1-1+C2:2011."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                r"= 100.000 \cdot \left(0.010\right) \cdot \frac{5.000^2}{10.000} = 2.500 \text{ kNm}",
            ),
            ("short", r"M_{2} = 2.500 \text{ kNm}"),
        ],
    )

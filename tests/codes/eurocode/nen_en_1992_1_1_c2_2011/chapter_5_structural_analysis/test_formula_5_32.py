"""Testing formula 5.32 of NEN-EN 1992-1-1+C2:2011."""

import pytest

from blueprints.codes.eurocode.nen_en_1992_1_1_c2_2011.chapter_5_structural_analysis.formula_5_32 import Form5Dot32EquivalentFirstOrderEndMoment
from blueprints.validations import NegativeValueError


class TestForm5Dot32EquivalentFirstOrderEndMoment:
    """Validation for formula 5.32 from NEN-EN 1992-1-1+C2:2011."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                r"= \max\left(0.6 \cdot 50.000 + 0.4 \cdot 30.000; 0.4 \cdot 50.000\right) = 42.000 \text{ kNm}",
            ),
            ("short", r"M_{0e} = 42.000 \text{ kNm}"),
        ],
    )

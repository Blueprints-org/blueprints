"""Testing formula 5.37 of NEN-EN 1992-1-1+C2:2011."""

import pytest

from blueprints.codes.eurocode.nen_en_1992_1_1_c2_2011.chapter_5_structural_analysis.formula_5_37 import Form5Dot37CreepFactor
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm5Dot37CreepFactor:
    """Validation for formula 5.37 from NEN-EN 1992-1-1+C2:2011."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                r"= \max\left(1 + \left(0.35 + \frac{30.000}{200} - \frac{2.000}{150}\right) \cdot 1.500; 1\right) = 1.730 \text{ -}",
            ),
            ("short", r"K_{\phi} = 1.730 \text{ -}"),
        ],
    )

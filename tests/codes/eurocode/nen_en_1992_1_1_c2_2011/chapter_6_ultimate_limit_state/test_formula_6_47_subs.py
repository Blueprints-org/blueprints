    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                r"\min \left( 1 + \sqrt{\frac{200}{500.000}}, 2.0 \right) = 1.632 \text{ -}",
            ),
            ("short", r"k = 1.632 \text{ -}"),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                r"\min \left( \sqrt{0.020 \cdot 0.030}, 0.02 \right) = 0.020 \text{ -}",
            ),
            ("short", r"\rho_l = 0.020 \text{ -}"),
        ],
    )
    def test_latex(self, representation: str, expected: str) -> None:
        """Test the latex representation of the formula."""
...
class TestSubForm6Dot47FactorSigmaCp:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "complete",
                r"\sigma_{cp} = \frac{\sigma_{cy} + \sigma_{cz}}{2} = " r"\frac{1.000 + 2.000}{2} = 1.500 \text{ MPa}",
            ),
            ("short", r"\sigma_{cp} = 1.500 \text{ MPa}"),
        ],
    )
    def test_latex(self, representation: str, expected: str) -> None:
        """Test the latex representation of the formula."""
...
class TestSubForm6Dot47FactorSigmaCy:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "complete",
                r"\sigma_{cy} = \frac{N_{Ed,y}}{A_{cy}} = " r"\frac{1000.000}{500.000} = 2.000 \text{ MPa}",
            ),
            ("short", r"\sigma_{cy} = 2.000 \text{ MPa}"),
        ],
    )
    def test_latex(self, representation: str, expected: str) -> None:
        """Test the latex representation of the formula."""
...
class TestSubForm6Dot47FactorSigmaCz:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "complete",
                r"\sigma_{cz} = \frac{N_{Ed,z}}{A_{cz}} = " r"\frac{2000.000}{1000.000} = 2.000 \text{ MPa}",
            ),
            ("short", r"\sigma_{cz} = 2.000 \text{ MPa}"),
        ],
    )
    def test_latex(self, representation: str, expected: str) -> None:
        """Test the latex representation of the formula."""

...
class TestForm6Dot1DesignShearStrength:
    ...
    def test_raise_error_when_negative_v_rd_s_is_given(self):
    ...
    def test_raise_error_when_negative_v_ccd_is_given(self):
    ...
    def test_raise_error_when_negative_v_td_is_given(self):

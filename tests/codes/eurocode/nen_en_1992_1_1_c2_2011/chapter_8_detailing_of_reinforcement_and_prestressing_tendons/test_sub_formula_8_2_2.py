...
class TestSubForm8Dot2CoefficientBarDiameter:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "complete_latex_16",
                r"\eta_2 = \begin{matrix} 1.0 & \text{for }\Phi ≤ 32 \\ (132 - \Phi) / 100 & \text{for }\Phi > 32  \end{matrix} = 1.00 = 1.00",
            ),
            ("short_latex_16", r"\eta_2 = 1.00"),
            (
                "complete_latex_64",
                r"\eta_2 = \begin{matrix} 1.0 & \text{for }\Phi ≤ 32 \\ (132 - \Phi) / 100 & "
                r"\text{for }\Phi > 32  \end{matrix} = (132 - 64) / 100 = 0.68",
            ),

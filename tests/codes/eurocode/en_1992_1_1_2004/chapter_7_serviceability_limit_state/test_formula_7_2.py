    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "complete",
                (
                    r"k_1 = \begin{cases} 1.5 & \text{if } N_{Ed} > 0 \\ \frac{2 \cdot min(h, 1000)}{3 \cdot h} & "
                    r"\text{if } N_{Ed} \le 0 \end{cases} = \begin{cases} 1.5 & \text{if } 5.000 > 0 \\ "
                    r"\frac{2 \cdot min(500.000, 1000)}{3 \cdot 500.000} & \text{if } 5.000 \le 0 \end{cases} = 1.500 \ -"
                ),
            ),
            ("short", r"k_1 = 1.500 \ -"),
        ],

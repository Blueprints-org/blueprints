...
from blueprints.codes.eurocode.pr_en_1992_1_2023.chapter_8_ultimate_limit_states.formula_8_53 import Form8Dot53TensileChordLimitForIntermediateSupportOrConcentratedLoads
...
class TestForm8Dot53TensileChordLimitForIntermediateSupportOrConcentratedLoads:
    ...
    def test_raise_error_when_negative_values_are_given(self, m_ed_max, z, n_ed) -> None:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "complete",
                r"F_{td,max} = \frac{M_{Ed,max}}{z} + \frac{N_{Ed}}{2} = \frac{120000000.000}{300.000} + \frac{10000.000}{2} = 405000.000 \ N",
            ),
            (
                "short",

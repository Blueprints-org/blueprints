...
class TestFormEDot10MaxShearStressInLayer2:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (FormE10Params(0.767, 4000, 12000, 60000, 0, 70, 80, 1000, 10e+03, 6015486104925.15), 0.0695920),
            (FormE10Params(0.86822, 12000, 12000, 30000, 12.035, 32.96469, 60, 1000, 20e+03, 2173632196491.10), 0.1664219),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (FormE10Params(0.767, 4000, 12000, 60000, 0, 70, 80, 1000, 10e+03, 6015486104925.15), does_not_raise()),
            (FormE10Params(0.767, 4000, 12000, 60000, 0, 70, 80, 1000, -10e+03, 6015486104925.15), does_not_raise()),
            (FormE10Params(0.767, -4000, 12000, 60000, 0, 70, 80, 1000, 10e+03, 6015486104925.15), pytest.raises(LessOrEqualToZeroError)),
            (FormE10Params(0.767, 4000, -12000, 60000, 0, 70, 80, 1000, 10e+03, 6015486104925.15), pytest.raises(LessOrEqualToZeroError)),
            (FormE10Params(0.767, 4000, 12000, -60000, 0, 70, 80, 1000, 10e+03, 6015486104925.15), pytest.raises(LessOrEqualToZeroError)),
            (FormE10Params(0.767, 4000, 12000, 60000, 0, -70, 80, 1000, 10e+03, 6015486104925.15), pytest.raises(LessOrEqualToZeroError)),
            (FormE10Params(0.767, 4000, 12000, 60000, 0, 70, 0, 1000, 10e+03, 6015486104925.15), pytest.raises(LessOrEqualToZeroError)),
            (FormE10Params(0.767, 4000, 12000, 60000, 0, 70, 80, -1000, 10e+03, 6015486104925.15), pytest.raises(LessOrEqualToZeroError)),
            (FormE10Params(0.767, 4000, 12000, 60000, 0, 70, 80, 1000, 10e+03, -6015486104925.15), pytest.raises(LessOrEqualToZeroError)),
        ],
        ids=["passes1",
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                FormE10Params(0.767, 4000, 12000, 60000, 0, 70, 80, 1000, 10e+03, 6015486104925.15),
                r"\tau_{2,max} = 0.07",
                r"\tau_{2,max} = \left[\gamma_3 E_3 A_3 \alpha_3"
                r" + 0.5 E_2 b_2 \left(\frac{\alpha_2 + h_2}{2}\right)^2\right] \frac{V_d}{b_{2} EI_{ef}}"

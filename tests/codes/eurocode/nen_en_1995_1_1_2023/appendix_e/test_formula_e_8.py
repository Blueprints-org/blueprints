...
class TestFormEDot8AxialStressInILayer:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (2, 1, 1, 1, 1, 1, 1),
            (1, 0.767, 12000, 70, 10e+06, 6015486104925.15, 1.071035),
            (2, 1, 4000, 20, 10e+6, 6.2e+12, 0.129032258),
            (3, 0.8, 12000, 60, -8e+6, 5.5e+12, -0.837818),
            (2, 1, 2000, -10, 0, 1e+12, 0),
        ],
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (3, 0.8, 12000, 60, -8e+6, 5.5e+12, does_not_raise()),
            (2, 1, 1, 0.0000001, 1, 1, does_not_raise()),
            (3, -0.8, 12000, 60, 8e+6, 5.5e+12, pytest.raises(LessOrEqualToZeroError)),
            (1, 0.8, -12000, 60, 8e+6, 5.5e+12, pytest.raises(LessOrEqualToZeroError)),
            (3, 0.8, 12000, 60, 8e+6, 0, pytest.raises(LessOrEqualToZeroError)),
            (4, 0.8, 12000, 60, 8e+6, 20, pytest.raises(ValueError, match="The number of the layer must be either 1, 2 or 3")),
            (0, 0.8, 12000, 60, 8e+6, 20, pytest.raises(ValueError, match="The number of the layer must be either 1, 2 or 3")),
            (3, 0.8, 12000, -60, 8e+6, 20, pytest.raises(LessOrEqualToZeroError)),
            (2, 0.8, 12000, -60, 8e+6, 30, does_not_raise()),
        ],
        ids=["passes1",
             "passes2",
             "passes3",

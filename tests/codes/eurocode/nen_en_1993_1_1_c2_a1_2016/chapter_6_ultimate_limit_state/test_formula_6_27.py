"""Testing formula 6.27 of NEN-EN 1993-1-1+C2+A1:2016."""

import pytest

from blueprints.codes.eurocode.nen_en_1993_1_1_c2_a1_2016.chapter_6_ultimate_limit_state.formula_6_27 import Form6Dot27VplTRdChannelSection
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm6Dot27VplTRdChannelSection:
    """Validation for formula 6.27 from NEN-EN 1993-1-1+C2+A1:2016."""
    ...
    def test_evaluation(self) -> None:
        ...
        # Object to test
        formula = Form6Dot27VplTRdChannelSection(
            tau_t_ed=tau_t_ed,
            f_y=f_y,
            gamma_m0=gamma_m0,
            tau_w_ed=tau_w_ed,
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Object to test
        latex = Form6Dot27VplTRdChannelSection(
            tau_t_ed=tau_t_ed,
            f_y=f_y,
            gamma_m0=gamma_m0,
            tau_w_ed=tau_w_ed,

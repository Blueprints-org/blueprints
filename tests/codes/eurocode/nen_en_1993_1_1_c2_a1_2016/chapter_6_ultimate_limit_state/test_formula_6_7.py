"""Testing formula 6.7 of NEN-EN 1993-1-1+C2+A1:2016."""

import pytest

from blueprints.codes.eurocode.nen_en_1993_1_1_c2_a1_2016.chapter_6_ultimate_limit_state.formula_6_7 import (
...
class TestForm6Dot7DesignUltimateResistanceNetCrossSection:
    """Validation for formula 6.7 from NEN-EN 1993-1-1+C2+A1:2016."""

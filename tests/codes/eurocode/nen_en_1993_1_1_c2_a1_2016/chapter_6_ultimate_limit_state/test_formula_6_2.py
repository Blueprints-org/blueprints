...
from blueprints.codes.eurocode.nen_en_1993_1_1_c2_a1_2016.chapter_6_ultimate_limit_state.formula_6_2 import Form6Dot2UtilizationRatio
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm6Dot2UtilizationRatio:
    """Validation for form 6.2 from NEN-EN 1993-1-1+C2+A1:2016."""
        ...
        [
            (
                ...
                (
                    ...
                    " \frac{5.000}{10.000} + \frac{4.000}{20.000} + \frac{3.000}{30.000} = 0.800"
                ),
            ),
            ("short", r"uc = 0.800"),
        ],

...
class TestForm8Dot37RhoWithTorsion:
    """Validation for formula 8.37 with torsion from EN 1993-1-1:2025, chapter 8, ultimate limit state."""
    ...
    def test_evaluation(self) -> None:
        ...
        # Object to test
        formula = Form8Dot37RhoWithTorsion(v_ed=v_ed, v_pl_t_rd=v_pl_t_rd)
    ...
    def test_raise_error_when_negative_values_are_given(self, v_ed: float, v_pl_t_rd: float) -> None:
        """Test invalid values."""
        with pytest.raises(NegativeValueError):
            Form8Dot37RhoWithTorsion(v_ed=v_ed, v_pl_t_rd=v_pl_t_rd)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Object to test
        latex = Form8Dot37RhoWithTorsion(v_ed=v_ed, v_pl_t_rd=v_pl_t_rd).latex()

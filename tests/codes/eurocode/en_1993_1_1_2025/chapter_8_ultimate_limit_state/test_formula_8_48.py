"""Testing formula 8.48 from EN 1993-1-1:2025, chapter 8, ultimate limit state."""

import pytest

from blueprints.codes.eurocode.en_1993_1_1_2025.chapter_8_ultimate_limit_state.formula_8_48 import Form8Dot48MomentReduction
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm8Dot48MomentReduction:
    """Validation for formula 8.48 from EN 1993-1-1:2025, chapter 8, ultimate limit state."""
    ...
    def test_evaluation(self) -> None:
        ...
        # Object to test
        formula = Form8Dot48MomentReduction(mpl_y_rd=mpl_y_rd, a=a, n=n)
    ...
    def test_raise_error_when_negative_values_are_given(self, mpl_y_rd: float, n: float) -> None:
        ...
        with pytest.raises(NegativeValueError):
            Form8Dot48MomentReduction(mpl_y_rd=mpl_y_rd, a=0.4, n=n)
    ...
    def test_raise_error_when_invalid_values_are_given(self, a: float) -> None:
        ...
        with pytest.raises((LessOrEqualToZeroError, NegativeValueError)):
            Form8Dot48MomentReduction(mpl_y_rd=10000.0, a=a, n=0.5)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Object to test
        latex = Form8Dot48MomentReduction(mpl_y_rd=mpl_y_rd, a=a, n=n).latex()

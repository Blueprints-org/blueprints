"""Testing formula 8.44 from EN 1993-1-1:2025, chapter 8, ultimate limit state."""

import pytest

from blueprints.codes.eurocode.en_1993_1_1_2025.chapter_8_ultimate_limit_state.formula_8_44 import Form8Dot44MNrdRectangular
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm8Dot44MNrdRectangular:
    """Validation for formula 8.44 from EN 1993-1-1:2025, chapter 8, ultimate limit state."""
    ...
    def test_evaluation(self) -> None:
        ...
        # Object to test
        formula = Form8Dot44MNrdRectangular(m_pl_rd=m_pl_rd, n_ed=n_ed, n_pl_rd=n_pl_rd)
    ...
    def test_raise_error_when_negative_values_are_given(self, m_pl_rd: float, n_ed: float, n_pl_rd: float) -> None:
        ...
        with pytest.raises((NegativeValueError, LessOrEqualToZeroError)):
            Form8Dot44MNrdRectangular(m_pl_rd=m_pl_rd, n_ed=n_ed, n_pl_rd=n_pl_rd)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Object to test
        latex = Form8Dot44MNrdRectangular(m_pl_rd=m_pl_rd, n_ed=n_ed, n_pl_rd=n_pl_rd).latex()

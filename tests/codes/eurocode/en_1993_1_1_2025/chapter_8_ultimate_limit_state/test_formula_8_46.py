"""Testing formula 8.46 from EN 1993-1-1:2025, chapter 8, ultimate limit state."""

import pytest

from blueprints.codes.eurocode.en_1993_1_1_2025.chapter_8_ultimate_limit_state.formula_8_46 import Form8Dot46CheckAxialForceY
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm8Dot46CheckAxialForceY:
    """Validation for formula 8.46 from EN 1993-1-1:2025, chapter 8, ultimate limit state."""
    ...
    def test_raise_error_when_invalid_values_are_given(self, h_w: float, t_w: float, f_y: float, gamma_m0: float) -> None:
        ...
        with pytest.raises((NegativeValueError, LessOrEqualToZeroError)):
            Form8Dot46CheckAxialForceY(n_ed=50.0, h_w=h_w, t_w=t_w, f_y=f_y, gamma_m0=gamma_m0)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        latex = Form8Dot46CheckAxialForceY(n_ed=n_ed, h_w=h_w, t_w=t_w, f_y=f_y, gamma_m0=gamma_m0).latex()

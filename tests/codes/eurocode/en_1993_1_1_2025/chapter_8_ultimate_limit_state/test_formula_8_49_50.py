...
class TestForm8Dot49And50MomentReduction:
    ...
    def test_evaluation_37(self) -> None:
        ...
        # Object to test
        formula = Form8Dot49And50MomentReduction(mpl_z_rd=mpl_z_rd, a=a, n=n)
    ...
    def test_raise_error_when_negative_values_are_given(self, mpl_z_rd: float, n: float) -> None:
        ...
        with pytest.raises(NegativeValueError):
            Form8Dot49And50MomentReduction(mpl_z_rd=mpl_z_rd, a=0.4, n=n)
    ...
    def test_raise_error_when_invalid_values_are_given(self, a: float) -> None:
        ...
        with pytest.raises(LessOrEqualToZeroError):
            Form8Dot49And50MomentReduction(mpl_z_rd=60000.0, a=a, n=0.5)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Object to test
        latex = Form8Dot49And50MomentReduction(mpl_z_rd=mpl_z_rd, a=a, n=n).latex()
...
class TestForm8Dot50N:
    ...
    def test_evaluation(self) -> None:
        ...
        # Object to test
        formula = Form8Dot50N(n_ed=n_ed, n_pl_rd=n_pl_rd)
    ...
    def test_raise_error_when_negative_values_are_given(self, n_ed: float, n_pl_rd: float) -> None:
        """Test invalid negative values."""
        with pytest.raises(NegativeValueError):
            Form8Dot50N(n_ed=n_ed, n_pl_rd=n_pl_rd)
    ...
    def test_raise_error_when_invalid_values_are_given(self, n_pl_rd: float) -> None:
        """Test invalid zero or negative values."""
        with pytest.raises(LessOrEqualToZeroError):
            Form8Dot50N(n_ed=50000.0, n_pl_rd=n_pl_rd)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Object to test
        latex = Form8Dot50N(n_ed=n_ed, n_pl_rd=n_pl_rd).latex()
...
class TestForm8Dot50A:
    ...
    def test_evaluation(self) -> None:
        ...
        # Object to test
        formula = Form8Dot50A(capital_a=capital_a, b=b, tf=tf)
    ...
    def test_raise_error_when_invalid_values_are_given(self, capital_a: float, b: float, tf: float) -> None:
        ...
        with pytest.raises((NegativeValueError, LessOrEqualToZeroError)):
            Form8Dot50A(capital_a=capital_a, b=b, tf=tf)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Object to test
        latex = Form8Dot50A(capital_a=capital_a, b=b, tf=tf).latex()

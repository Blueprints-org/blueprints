...
class TestForm8Dot5MinDeductionAreaStaggeredFastenerHoles:
    ...
    def test_evaluation(self) -> None:
        ...
        # Object to test
        formula = Form8Dot5MinDeductionAreaStaggeredFastenerHoles(t=t, n=n, d_0=d_0, s=s, p=p)
    ...
    def test_raise_error_when_invalid_values_are_given(self, t: float, n: float, d_0: float, s: list[float], p: list[float]) -> None:
        ...
        with pytest.raises((NegativeValueError, LessOrEqualToZeroError, ListsNotSameLengthError)):
            Form8Dot5MinDeductionAreaStaggeredFastenerHoles(t=t, n=n, d_0=d_0, s=s, p=p)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Object to test
        latex = Form8Dot5MinDeductionAreaStaggeredFastenerHoles(t=t, n=n, d_0=d_0, s=s, p=p).latex()

"""Testing formula 8.45 from EN 1993-1-1:2025, chapter 8, ultimate limit state."""

import pytest

from blueprints.codes.eurocode.en_1993_1_1_2025.chapter_8_ultimate_limit_state.formula_8_45 import Form8Dot45CheckAxialForceY
from blueprints.validations import NegativeValueError


class TestForm8Dot45CheckAxialForceY:
    """Validation for formula 8.45 from EN 1993-1-1:2025, chapter 8, ultimate limit state."""
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        latex = Form8Dot45CheckAxialForceY(n_ed=n_ed, n_pl_rd=n_pl_rd).latex()

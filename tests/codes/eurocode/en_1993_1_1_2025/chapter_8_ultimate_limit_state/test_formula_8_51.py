"""Testing formula 8.51 from EN 1993-1-1:2025, chapter 8, ultimate limit state."""

import pytest

from blueprints.codes.eurocode.en_1993_1_1_2025.chapter_8_ultimate_limit_state.formula_8_51 import Form8Dot51ReducedBendingMomentResistance
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm8Dot51ReducedBendingMomentResistance:
    """Validation for formula 8.51 from EN 1993-1-1:2025, chapter 8, ultimate limit state."""
    ...
    def test_evaluation(self) -> None:
        ...
        formula = Form8Dot51ReducedBendingMomentResistance(mpl_y_rd=mpl_y_rd, n=n, a_w=a_w)
    ...
    def test_raise_error_when_invalid_values_are_given(self, mpl_y_rd: float, n: float, a_w: float) -> None:
        ...
        with pytest.raises((NegativeValueError, LessOrEqualToZeroError)):
            Form8Dot51ReducedBendingMomentResistance(mpl_y_rd=mpl_y_rd, n=n, a_w=a_w)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        latex = Form8Dot51ReducedBendingMomentResistance(mpl_y_rd=mpl_y_rd, n=n, a_w=a_w).latex()

...
class TestForm8Dot57AdditionalBendingMoment:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (-2.0, 0.002, 435.0, 2.0, 400.0, 300.0, 600.0, 200.0),  # tau_ed is negative
            (2.0, -0.002, 435.0, 2.0, 400.0, 300.0, 600.0, 200.0),  # rho_w is negative
            (2.0, 0.002, -435.0, 2.0, 400.0, 300.0, 600.0, 200.0),  # f_ywd is negative
            (2.0, 0.002, 435.0, -2.0, 400.0, 300.0, 600.0, 200.0),  # cot_theta is negative
            (2.0, 0.002, 435.0, 2.0, -400.0, 300.0, 600.0, 200.0),  # z is negative
            (2.0, 0.002, 435.0, 2.0, 400.0, -300.0, 600.0, 200.0),  # b_w is negative
            (2.0, 0.002, 435.0, 2.0, 400.0, 300.0, -600.0, 200.0),  # a is negative
            (2.0, 0.002, 435.0, 2.0, 400.0, 300.0, 600.0, -200.0),  # x is negative
        ],
    )
    def test_raise_error_when_negative_values_are_given(
        ...
        with pytest.raises(NegativeValueError):
            Form8Dot57AdditionalBendingMoment(tau_ed=tau_ed, rho_w=rho_w, f_ywd=f_ywd, cot_theta=cot_theta, z=z, b_w=b_w, a=a, x=x)
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                r"\left(2.000 - 0.002 \cdot 435.000 \cdot 2.000\right) "
            ...
            (
                ...
                r"\Delta M_{Ed} = \left(\tau_{Ed} - \rho_w \cdot f_{ywd} \cdot \cot(\theta)\right) "
                r"\cdot z \cdot b_w \cdot \left(\frac{a}{2} - x\right) = "
                r"\left(2.000 \ MPa - 0.002 \cdot 435.000 \ MPa \cdot 2.000\right) "

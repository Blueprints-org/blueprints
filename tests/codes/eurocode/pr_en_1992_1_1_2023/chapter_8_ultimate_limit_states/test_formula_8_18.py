...
from blueprints.codes.eurocode.pr_en_1992_1_1_2023.chapter_8_ultimate_limit_states.formula_8_18 import Form8Dot18AverageShearStress
from blueprints.validations import LessOrEqualToZeroError, NegativeValueError


class TestForm8Dot18AverageShearStress:
    """Validation for formula 8.18 from prEN 1992-1-1:2023."""
    ...
    def test_evaluation(self) -> None:
        ...
        test_formula = Form8Dot18AverageShearStress(v_ed=v_ed, b_w=b_w, z=z)

        # Expected result, manually calculated
        manually_calculated_result = 0.93023  # MPa

        # Perform test by assert
        assert test_formula == pytest.approx(expected=manually_calculated_result, rel=1e-4)
    ...
    def test_raise_error_when_negative_values_are_given(self, v_ed: float, b_w: float, z: float) -> None:

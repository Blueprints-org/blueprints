...
from blueprints.codes.eurocode.national_annex.nl.nen_en_1993_1_1_2006.chapter_5_structural_analysis.formula_5_1 import (
    Form5Dot1NLCriteriumDisregardSecondOrderEffects,
)
from blueprints.validations import MismatchSignError


class TestForm5Dot1NLCriteriumDisregardSecondOrderEffects:
    ...
    testdata: ClassVar[list[tuple[float, float, str, bool, float]]] = [
        ...
        (1000000, 50000, "plastic", True, 0.50),
        (1000000, 110000, "plastic", False, 1.10),
        (-1000000, -110000, "plastic", False, 1.10),
    ]
    ...
    def test_evaluation(self, f_cr: float, f_ed: float, analysis_type: Literal["elastic", "plastic"], exp_result: bool, exp_uc: float) -> None:
        ...
        form = Form5Dot1NLCriteriumDisregardSecondOrderEffects(f_cr=f_cr, f_ed=f_ed, analysis_type=analysis_type)
    ...
    def test_error_mismatch_sign(self, f_cr: float, f_ed: float, analysis_type: Literal["elastic", "plastic"]) -> None:
        ...
        with pytest.raises(MismatchSignError):
            Form5Dot1NLCriteriumDisregardSecondOrderEffects(f_cr=f_cr, f_ed=f_ed, analysis_type=analysis_type)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        f_cr = 1000000
        f_ed = 100000
        analysis_type: Literal["elastic", "plastic"] = "elastic"

        # Create test object
        latex = Form5Dot1NLCriteriumDisregardSecondOrderEffects(f_cr=f_cr, f_ed=f_ed, analysis_type=analysis_type).latex()

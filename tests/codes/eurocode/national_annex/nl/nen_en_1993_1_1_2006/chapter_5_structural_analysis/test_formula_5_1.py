...
class TestFrom5Dot1NLCriteriumDisregardSecondOrderEffects:
    ...
    def test_evaluation(self, f_cr: float, f_ed: float, analysis_type: Literal["elastic", "plastic"], exp_result: bool, exp_uc: float) -> None:
        ...
        form = From5Dot1NLCriteriumDisregardSecondOrderEffects(f_cr=f_cr, f_ed=f_ed, analysis_type=analysis_type)
    ...
    def test_error_mismatch_sign(self, f_cr: float, f_ed: float, analysis_type: Literal["elastic", "plastic"]) -> None:
        ...
        with pytest.raises(MismatchSignError):
            From5Dot1NLCriteriumDisregardSecondOrderEffects(f_cr=f_cr, f_ed=f_ed, analysis_type=analysis_type)
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Create test object
        latex = From5Dot1NLCriteriumDisregardSecondOrderEffects(f_cr=f_cr, f_ed=f_ed, analysis_type=analysis_type).latex()

"""Testing formula 4.2 of NEN-EN 1992-1-1:2005+A1:2015+NB:2016+A1:2020."""

import pytest

from blueprints.codes.eurocode.national_annex.nl.nen_en_1992_1_1_a1_2020.chapter_4_durability_and_cover.formula_4_2 import (
...
class TestForm4Dot1NominalConcreteCover:
    """Validation for formula 4.2 from NEN-EN 1992-1-1:2005+A1:2015+NB:2016+A1:2020."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                r"\ mm\right\} = \max \left\{15; 10+5-5-0; 10\right\} = 15.0",
            ),
            ("short", "c_{min} = 15.0"),
            (
                "string",

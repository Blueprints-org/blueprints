...
from blueprints.codes.eurocode.en_1993_1_1_2005.chapter_5_structural_analysis.formula_5_7 import Form5Dot7NeglectFrameTilt
...
class TestForm5Dot8NeglectFrameTilt:
    ...
    def test_evaluation(self) -> None:
        ...
        # Create test object
        form = Form5Dot7NeglectFrameTilt(
            h_ed=h_ed,
            v_ed=v_ed
        )
    ...
    def test_latex(self, representation: str, expected: str) -> None:
        ...
        # Create test object
        latex = Form5Dot7NeglectFrameTilt(
            h_ed=h_ed,
            v_ed=v_ed
        ).latex()

"""Testing formula 5.2 of EN 1993-1-1:2005."""

import pytest

from blueprints.codes.eurocode.en_1993_1_1_2005.chapter_5_structural_analysis.formula_5_2 import (
...
class TestForm5Dot2ElasticCriticalBucklingFactor:
    """Validation for formula 5.2 from EN 1993-1-1:2005."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (-100.0, 500.0, 3500.0, 10.0, MismatchSignError),  # h_ed and v_ed have mismatch sign
            (100.0, 0.0, 3500.0, 10.0, ValueError),  # v_ed is zero

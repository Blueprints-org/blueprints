...
chs_profile = CHSProfiles(profile=CHS.CHS_273x5, steel_class=steel_class).get_profile()
...
rhs_profile = RHSProfiles(profile=RHS.RHS120x60_4, steel_class=steel_class).get_profile()
...
i_profile = IProfiles(profile=HEB.HEB_200, steel_class=steel_class).get_profile()
...
strip_profile = StripProfiles(profile=Strip.STRIP_160x5, steel_class=steel_class).get_profile()

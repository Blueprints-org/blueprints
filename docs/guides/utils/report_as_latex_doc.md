...
This notebook demonstrates how to use the `Report` class to build engineering reports and export them to LaTeX `.tex` files with language localization. For more notes on how to build a report, see the `Report.md` file.
